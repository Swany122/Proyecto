...
public class Mantenimiento extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        setTitle("Mantenimiento librería");
        ...
        jPanel1.add(jPanel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 500, 25));
        ...
        jPanel1.add(jButton2, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 450, -1, -1));
        ...
        jPanel1.add(jTextField1, new org.netbeans.lib.awtextra.AbsoluteConstraints(100, 100, 140, -1));
        ...
        jPanel1.add(jTextField2, new org.netbeans.lib.awtextra.AbsoluteConstraints(340, 100, 140, -1));

        jLabel3.setFont(new java.awt.Font("Leelawadee UI", 0, 18)); // NOI18N
        jLabel3.setForeground(new java.awt.Color(255, 247, 247));
        ...
        jLabel4.setForeground(new java.awt.Color(255, 247, 247));
        jLabel4.setText("NIT");
        ...
        jPanel1.add(jTextField3, new org.netbeans.lib.awtextra.AbsoluteConstraints(320, 140, 150, -1));

        jLabel5.setFont(new java.awt.Font("Leelawadee UI", 0, 18)); // NOI18N
        jLabel5.setForeground(new java.awt.Color(255, 247, 247));
        ...
        jPanel1.add(jTextField4, new org.netbeans.lib.awtextra.AbsoluteConstraints(370, 180, 100, -1));

        jLabel6.setFont(new java.awt.Font("Leelawadee UI", 0, 18)); // NOI18N
        jLabel6.setForeground(new java.awt.Color(255, 247, 247));
        ...
        jLabel7.setForeground(new java.awt.Color(255, 247, 247));
        jLabel7.setText("Dirección");
        jPanel1.add(jLabel7, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 180, -1, -1));

        jTextField5.setFont(new java.awt.Font("Leelawadee", 0, 18)); // NOI18N
        jTextField5.setPreferredSize(new java.awt.Dimension(71, 30));
        jPanel1.add(jTextField5, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 220, 300, -1));

        jTextField6.setFont(new java.awt.Font("Leelawadee", 0, 18)); // NOI18N
        jTextField6.setPreferredSize(new java.awt.Dimension(64, 30));
        jPanel1.add(jTextField6, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 180, 150, -1));

        jLabel8.setFont(new java.awt.Font("Leelawadee UI", 1, 18)); // NOI18N
        jLabel8.setForeground(new java.awt.Color(255, 247, 247));
        jLabel8.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel8.setText("Mantenimiento de clientes");
        jPanel1.add(jLabel8, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 40, 500, -1));

        jComboBox1.setBackground(new java.awt.Color(255, 247, 247));
        jComboBox1.setFont(new java.awt.Font("Leelawadee", 0, 18)); // NOI18N
        jComboBox1.setForeground(new java.awt.Color(0, 0, 0));
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "", "Masculino", "Femenino" }));
        jComboBox1.setBorder(null);
        jComboBox1.setMinimumSize(new java.awt.Dimension(122, 25));
        jPanel1.add(jComboBox1, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 140, -1, -1));
        ...
        jButton3.setForeground(new java.awt.Color(255, 247, 247));
        jButton3.setText("Modificar");
        jPanel1.add(jButton3, new org.netbeans.lib.awtextra.AbsoluteConstraints(140, 260, -1, -1));

        jButton4.setBackground(new java.awt.Color(60, 60, 60));
        jButton4.setFont(new java.awt.Font("Leelawadee UI", 0, 18)); // NOI18N
        jButton4.setForeground(new java.awt.Color(255, 247, 247));
        ...
        jButton5.setForeground(new java.awt.Color(255, 247, 247));
